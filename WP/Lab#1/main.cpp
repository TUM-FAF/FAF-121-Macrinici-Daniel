...
int WINAPI WinMain ( HINSTANCE hThisInstance, HINSTANCE hPrevInstance, LPSTR lpszArgument, int nCmdShow ) {
        ...
        hwnd = CreateWindowEx (
           ...
           _T("My first laboratory work"),              /* Title Text */
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
        TCHAR info_string[] = "First lab performed by Macrinici Daniel, 2014";
        ...
        * the folowing message WM_SYSCOLORCHANGE is used to Invalidate the client-area rectangle
        ...
        ********************************* by modifying DRAWITEMSTRUCT****************/
            ...
            case WM_SYSCOMMAND: {
                switch(wParam) {
                    case SC_MINIMIZE:
                    return MessageBox(NULL, TEXT("Cannot Minimize!"), TEXT("Minimize Button Clicked!"), MB_OK | MB_ICONWARNING);

                    break;

                    case SC_MAXIMIZE:
                    return MessageBox(NULL, TEXT("Maximizing not possible..."), TEXT("Maximize Button Clicked!"), MB_OK | MB_ICONASTERISK);
                    ...
                    return MessageBox(NULL, TEXT("Window moved to a random location on screen"), TEXT("Move!"), MB_OK | MB_ICONASTERISK);
